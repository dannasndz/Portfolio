...
const ScrollReveal: React.FC<ScrollRevealProps> = ({
  ...
  useEffect(() => {
    ...
    if (isStringChild) {
      // Modo texto: anima palabra por palabra
      ...
      // Modo elemento: anima el contenedor completo
      gsap.fromTo(
        el,
        {
          opacity: baseOpacity,
  ...
  // Modo elemento: wrapper neutro sin estilos de texto
  return (
